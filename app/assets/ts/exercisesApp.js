...
exeModule.controller('exercise1Controller', ['$scope', '$location', '$route', '$rootScope', 'allTexts', 'exercise1Service', function ($scope, $location, $route, $rootScope, allTexts, exercise1Service) {
...
exeModule.controller('exercise2Controller', ['$scope', '$location', '$route', '$rootScope', 'allTexts', 'exercise2Service', function ($scope, $location, $route, $rootScope, allTexts, exercise2Service) {
...
exeModule.controller('exe1SubCtrl', ['$scope', 'exercise1Service', function ($scope, exercise1Service) {
        var self = this;
        ...
        self.setUserInput = function (newVal) {
            ...
            else if (String(self.userInput).length < 2) {
...
exeModule.controller('exe1SubCtrlSummary', ['$scope', 'exercise1Service', function ($scope, exercise1Service) {
        var self = this;
        var index = $scope.$parent.$index;
        exercise1Service.setCurrentSubExercise(index);
        self.imgUrl = "app/assets/img/pink-flower.png";
...
exeModule.controller('exe2SubCtrl', ['$scope', '$rootScope', 'exercise2Service', function ($scope, $rootScope, exercise2Service) {
        var self = this;
        var index = $scope.$parent.$index;
        self.imgUrl = "app/assets/img/pink-flower.png";
...
exeModule.controller('exe2SubCtrlSummary', ['$scope', 'exercise2Service', function ($scope, exercise2Service) {
        var self = this;
        var index = $scope.$parent.$index;
        self.imgUrl = "app/assets/img/pink-flower.png";
        exercise2Service.setCurrentSubExercise(index);
...
exeModule.service('exercise1Service', ['$rootScope', '$http', function ($rootScope, $http) {
        var elements = [];
        var current = 0;
...
//# sourceMappingURL=exercisesApp.js.map